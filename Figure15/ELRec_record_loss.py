...
from ELRec_dlrm import ELRec_DLRM_Net, ELRec_DLRM_Net_terabyte
...
if __name__ == "__main__":
    ...
    if os.path.exists('loss_record/ELRec.txt'):
        print("ELRec.txt exists, skip training")
        exit()
    ...
    if not os.path.exists('loss_record/ELRec.txt'):
        with open('loss_record/ELRec.txt', 'w') as f:
