...
if __name__ == "__main__":
    ...
    if os.path.exists('loss_record/TTRec.txt'):
        print("TTRec.txt exists, skip training")
        exit()
    ...
    if not os.path.exists('loss_record/TTRec.txt'):
        with open('loss_record/TTRec.txt', 'w') as f:
