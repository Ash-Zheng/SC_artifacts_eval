...
if __name__ == "__main__":
    ...
    unique_gen = unique_generator(batch_size=batch_size, nDev=1, table_num=table_num, rank=0, dataloader=train_iter, generate=False, dataset=dataset)
    num_iters = 1000
    ...
    for i in tqdm(range(num_iters)):
        ...
        z = dlrm(dense, sparse, unique, inverse)
        E = loss_fn(z, label)
    ...
    with open('out.log', 'a') as f:
        f.write("ELRec, {}, time: {:.3f}\n".format(dataset_name, end-start))
