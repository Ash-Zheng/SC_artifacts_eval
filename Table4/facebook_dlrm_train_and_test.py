...
if __name__ == "__main__":
    ...
    if not os.path.exists("trained_models/Facebook_DLRM_{}.pkl".format(dataset)):
        ...
        for i in range(num_epoch):
            ...
            if acc > best_acc:
                best_acc = acc
                torch.save(dlrm, "trained_models/Facebook_DLRM_{}.pkl".format(dataset))
            print("acc:",acc,"best acc:",best_acc)
    
    else:
        dlrm = torch.load("trained_models/Facebook_DLRM_{}.pkl".format(dataset))   
